...
export default function Card({ avatar, userName, applicationName, userID }) {
  return (
    <Link href={`/user/${userID}`} passHref>
      <div className="bg-white shadow-md p-4 rounded-lg cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:bg-slate-100 duration-300">
